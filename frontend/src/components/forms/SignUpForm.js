...
//   // Updated to include all fields from your Mongoose schemas
...
//     designation: "",
//     TeacherIdNumber: "",
//     // Shared between Student & Teacher
//     department: "",
//     // Admin specific (optional security check)
//     adminKey: "",
//   });
...
//     try {
//       // 1. Base data that goes to the User Schema
//       const payload = {
//         name: formData.name,
...
//       // 2. Append role-specific data based on your Mongoose Schemas
//       if (accountType === "student") {
//         payload.rollNumber = formData.rollNumber;
//         payload.department = formData.department;
//         payload.year = Number(formData.year); // Cast to Number to match schema
//       } else if (accountType === "teacher") {
//         payload.department = formData.department;
//         payload.designation = formData.designation;
//         payload.TeacherIdNumber = formData.TeacherIdNumber;
//       } else if (accountType === "admin") {
//         payload.adminKey = formData.adminKey; // For backend verification
//       }
...
//             onClick={() => {
//               setAccountType(role);
//               // Optional: Clear form data when switching tabs so old data doesn't linger
//               setFormData({ ...formData, rollNumber: "", year: "", designation: "", TeacherIdNumber: "", department: "", adminKey: "" });
//             }}
...
//         {/* === CORE USER FIELDS (Name, Email, Password) === */}
//         <input
//           type="text"
//           name="name"
//           required
...
//           className="bg-richblack-800 text-white p-3 rounded-lg w-full outline-none"
//         />
...
//               onChange={changeHandler}
//               className="bg-richblack-800 text-white p-3 rounded-lg w-full outline-none border border-yellow-500/30"
//             />
//             <input
//               type="text"
//               name="department"
...
//             onChange={changeHandler}
//             className="bg-richblack-800 text-white p-3 rounded-lg w-full outline-none border border-red-500/50"
//           />
//         )}

//         <button
//           disabled={loading}
//           className="bg-yellow-500 text-black py-3 rounded-lg w-full font-bold mt-6 hover:bg-yellow-400 transition-colors"
//         >
